...
ДОРОЖНАЯ КАРТА ЗАВЕРШЕНА. Возможные направления дальше (обсудить с владельцем):
контент главы 2 (город Flux Nomads, Сайла/Hydrosynth, больше фракций), торговля,
крафт, звук/музыка, арт (портреты, фоны), мобильное тестирование экспорта,
публикация демо (itch.io / GitHub Pages).
